...
const ShopByCategory = () => {
  ...
  return (
    <div className="text-center mt-10">
      <h2 className="text-4xl font-bold mb-6 text-pink-500">Shop By Category</h2>
      <div className="flex justify-center space-x-4 flex-wrap sm:flex-nowrap">
        {categories.map((category, index) => (
          ...
          >
            ...
            <p className="text-xs sm:text-sm md:text-md font-bold text-pink-500">{category.name}</p>
          </div>
        ))}
      </div>
    </div>
