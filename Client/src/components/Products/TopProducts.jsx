...
const TopProducts = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance.get(endPoints.PRODUCTS.GET_ALL_PRODUCTS)
      .then(response => {
        const products = response.data.allProducts || response.data;
        const filteredProducts = products.filter(product => product.stars >=4.6);
